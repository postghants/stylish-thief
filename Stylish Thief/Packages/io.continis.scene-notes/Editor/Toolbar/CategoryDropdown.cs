...
namespace SceneNotes.Toolbar
{
    ...
    public sealed class CategoryDropdown : DropdownToggleBase
    {
        ...
        public CategoryDropdown()
        {
            ...
            FiltersChanged += RefreshFilterStateFromExternal;
        ...
        public static void NotifyFiltersChanged() => FiltersChanged?.Invoke();

        protected override void OnFiltersApplied() => NotifyFiltersChanged();

        private void RefreshFilterStateFromExternal()
        {
            if (_dropdownValues == null) return;
            bool usingFilters = EditingSession.GetBool(_isOnSessionKey);
