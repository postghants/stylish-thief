                ...
                menu.InsertAction(i, "Copy", action =>
                {
                    ...
                    EditorGUIUtility.systemCopyBuffer = "UnityEditor.ObjectWrapperJSON:" + JsonUtility.ToJson(
                        new ClipboardData
                        {
                            ...
                            entityId = EntityId.ToULong(currentValue.GetEntityId()),
#else
...
#if UNITY_6000_4_OR_NEWER
                        Object obj = EditorUtility.EntityIdToObject(EntityId.FromULong(clipboardData.entityId));
#elif UNITY_6000_3_OR_NEWER
                        Object obj = EditorUtility.EntityIdToObject(clipboardData.instanceID);
#else
